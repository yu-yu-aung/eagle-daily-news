export const articles = [
  {
    ...
    description:
      "Polling places in seven counties are affected, though officials say the threats are not credible.",
    content:
  ...
  },
  {
    ...
    title:
      "Sinclair Asked Erika Kirk if They Could Get Jimmy Kimmel to Apologize",
    description:
